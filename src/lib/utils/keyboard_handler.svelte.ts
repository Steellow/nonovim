import { clues, gameHeight, gameWidth, keyboardBuffer } from '$lib/state.svelte';
 ...
 */
const changeCellState = (state: CellState, shouldCheckClues: boolean = false): boolean => {
...
const checkSingleRowClues = (clueSet: ClueSetWithState, gameBoardRow: CellState[]) => {
 ...
 */
const checkSingleRowCluesReversed = (clueSet: ClueSetWithState, gameBoardRow: CellState[]) => {
